    ...
    schemas: {
      StorySummary: {
        ...
        properties: {
          ...
          psq_score: { type: ['number', 'null'], description: 'Psychological safety quotient [0, 10]' },
          psq_confidence: { type: ['number', 'null'], description: 'PSQ confidence [0, 1]' },
        },
      },
      DomainAggregate: {
        type: 'object',
        properties: {
          ...
          avg_psq: { type: ['number', 'null'], description: 'Average PSQ score [0, 10]' },
      ...
      RaterEval: {
        ...
        properties: {
          ...
          prompt_mode: { type: 'string', enum: ['full', 'lite', 'lite-v2'] },
          eval_status: { type: 'string' },
          hcb_editorial_mean: { type: ['number', 'null'] },
          hcb_weighted_mean: { type: ['number', 'null'] },
          psq_score: { type: ['number', 'null'], description: 'Psychological safety quotient [0, 10]' },
          psq_dimensions_json: { type: ['string', 'null'], description: 'PSQ dimension scores as JSON array' },
          evaluated_at: { type: ['string', 'null'], format: 'date-time' },
        },
      },
      ArticleStats: {
